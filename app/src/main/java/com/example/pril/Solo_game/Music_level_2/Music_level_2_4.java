package com.example.pril.Solo_game.Music_level_2;
...
import com.example.pril.Solo_game.Music_level_service.Music_level_service_7;
import com.example.pril.Solo_game.Music_level_service.Music_level_service_8;
import com.example.pril.Solo_game.Music_level_service.Music_level_service_9;
import com.example.pril.Solo_game.Second_level.SoloGame_second_2;
import com.example.pril.Solo_game.SoloGame_menu;
import com.example.pril.Solo_game.music_level_1.Music_level_1_3;

public class Music_level_2_4 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.music_level_2_4);
        ...
        Intent start_music = new Intent(Music_level_2_4.this, Music_level_service_9.class);
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                stopService(new Intent(Music_level_2_4.this, Music_level_service_9.class));
                Intent intent = new Intent(Music_level_2_4.this, Music_level_2_5.class);
        ...
        //вопрос
        tv_quest.setText("Кто исполнитель данной песни?");
        tv_points.setText("Очки: "+String.valueOf(points));
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                is_started = false;
                stopService(new Intent(Music_level_2_4.this, Music_level_service_9.class));
                Intent intent = new Intent(Music_level_2_4.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
