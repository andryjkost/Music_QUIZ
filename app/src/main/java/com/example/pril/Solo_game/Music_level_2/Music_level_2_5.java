...
public class Music_level_2_5 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.music_level_2_5);
        ...
        Intent start_music = new Intent(Music_level_2_5.this, Music_level_service_10.class);
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                is_started = false;
                stopService(new Intent(Music_level_2_5.this, Music_level_service_10.class));
                Intent intent = new Intent(Music_level_2_5.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
