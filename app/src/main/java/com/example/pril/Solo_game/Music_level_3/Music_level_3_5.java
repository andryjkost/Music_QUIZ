...
import com.example.pril.Solo_game.Music_level_service.Music_level_service_15;
...
public class Music_level_3_5 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.music_level_3_5);
        ...
        Intent start_music = new Intent(Music_level_3_5.this, Music_level_service_15.class);
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                stopService(new Intent(Music_level_3_5.this, Music_level_service_15.class));
                Intent intent = new Intent(Music_level_3_5.this, SoloGame_itog.class);
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                is_started = false;
                stopService(new Intent(Music_level_3_5.this, Music_level_service_15.class));
                Intent intent = new Intent(Music_level_3_5.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
