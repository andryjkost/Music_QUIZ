package com.example.pril.Solo_game.Music_level_4;
...
import com.example.pril.Solo_game.Music_level_2.Music_level_2_4;
import com.example.pril.Solo_game.Music_level_service.Music_level_service_18;
...
public class Music_level_4_3 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.music_level_4_3);
        ...
        Intent start_music = new Intent(Music_level_4_3.this, Music_level_service_18.class);
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                stopService(new Intent(Music_level_4_3.this, Music_level_service_18.class));
                Intent intent = new Intent(Music_level_4_3.this, Music_level_4_4.class);
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                is_started = false;
                stopService(new Intent(Music_level_4_3.this, Music_level_service_18.class));
                Intent intent = new Intent(Music_level_4_3.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
