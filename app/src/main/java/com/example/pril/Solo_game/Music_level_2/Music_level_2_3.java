...
public class Music_level_2_3 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.music_level_2_3);
        ...
        Intent start_music = new Intent(Music_level_2_3.this, Music_level_service_8.class);
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                stopService(new Intent(Music_level_2_3.this, Music_level_service_8.class));
                Intent intent = new Intent(Music_level_2_3.this, Music_level_2_4.class);
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                is_started = false;
                stopService(new Intent(Music_level_2_3.this, Music_level_service_8.class));
                Intent intent = new Intent(Music_level_2_3.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
