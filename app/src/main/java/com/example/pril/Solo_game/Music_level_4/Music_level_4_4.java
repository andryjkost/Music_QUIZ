...
import com.example.pril.Solo_game.Music_level_service.Music_level_service_19;
import com.example.pril.Solo_game.SoloGame_menu;
import com.example.pril.Solo_game.music_level_1.Music_level_1_2;

public class Music_level_4_4 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.music_level_4_4);
        ...
        Intent start_music = new Intent(Music_level_4_4.this, Music_level_service_19.class);
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                stopService(new Intent(Music_level_4_4.this, Music_level_service_19.class));
                Intent intent = new Intent(Music_level_4_4.this,  Music_level_4_5.class);
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                is_started = false;
                stopService(new Intent(Music_level_4_4.this, Music_level_service_19.class));
                Intent intent = new Intent(Music_level_4_4.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
